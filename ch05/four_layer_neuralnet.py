...
network = MultiLayerNet(input_size=122, hidden_size_01=86, hidden_size_02=50, hidden_size_03=26, output_size=2)
...
plt.savefig("./Graph_four_layer_neuralnet/{}-{}-{}-{}:{}:{}.png".format(year,month,day,hour,minute,second))
